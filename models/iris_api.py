...
from .iris_torch import InterpretableRiskClusteringIntelligenceTorch
from utils import losses as losses
from utils.model_utils import train_iris
...
class IRISBase():
    ...
    def __init__(self, k=3, layers=None, distribution="Weibull",
                 temp=1000., discount=1.0, random_state=42, fix=False, num_units=[], is_seed=False):
        self.k = k
        self.layers = layers
    ...
    def _gen_torch_model(self, inputdim, optimizer, risks):
        ...
        return InterpretableRiskClusteringIntelligenceTorch(inputdim,
                                         k=self.k,
                                         layers=self.layers,
                                         dist=self.dist,
                                         temp=self.temp,
    ...
    def fit(self, x, t, e, vsize=0.15, val_data=None,
        ...
        r"""This method is used to train an instance of the IRIS model.
...
class InterpretableRiskClusteringIntelligence(IRISBase):
    """A Deep Survival Machines model.
      ...
      Example
      -------
      from iris import DeepSurvivalMachines
